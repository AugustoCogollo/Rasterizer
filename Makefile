...
SRC_FILES = ./src/*.c ./src/Display/*.c ./src/Vectors/*.c ./src/Mesh/*.c ./src/Triangle/*.c ./src/DArray/*.c ./src/Colors/*.c ./src/Matrix/*.c ./src/Light/*.c ./src/Texture/*.c ./src/Helper/Swap/*.c ./src/Helper/Mathr/*.c
OBJ_NAME = -o renderer

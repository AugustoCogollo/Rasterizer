...
face_t cube_faces[N_CUBE_FACES] = {
    //front
    { .a = 1, .b = 2, .c = 3, .color.value = 0xFFFF0000 },
    { .a = 1, .b = 3, .c = 4, .color.value = 0xFFFF0000 },
    //right
    { .a = 4, .b = 3, .c = 5, .color.value = 0xFF0000FF },
    { .a = 4, .b = 5, .c = 6, .color.value = 0xFF0000FF },
    //back
    { .a = 6, .b = 5, .c = 7, .color.value = 0xFF00FF00 },
    { .a = 6, .b = 7, .c = 8, .color.value = 0xFF00FF00 },
    //left
    { .a = 8, .b = 7, .c = 2, .color.value = 0xFF00FFFF },
    { .a = 8, .b = 2, .c = 1, .color.value = 0xFF00FFFF },
    //top
    { .a = 2, .b = 7, .c = 5, .color.value = 0xFF7F7F7F },
    { .a = 2, .b = 5, .c = 3, .color.value = 0xFF7F7F7F },
    //bottom
    { .a = 6, .b = 8, .c = 1, .color.value = 0xFFFFFF00 },
    { .a = 6, .b = 1, .c = 4, .color.value = 0xFFFFFF00 }
};
